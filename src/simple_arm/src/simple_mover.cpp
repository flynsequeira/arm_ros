...
int main(int argc, char** argv){
    ...
    // Create a publisher that can publish a 
    // std_msgs::Float64 message on the
    // /simple_arm/joint_1(and)2_position_controller/command topic
